            ...
            >
                ...
                {userId ? (
                  <>
                    ...
                    <Link to="/mygames" style={{ textDecoration: "none" }}>
                      <li
                        className={`nav-item nav-link ${active === "mygames" ? "active" : ""
                          }`}
              ...
              <div className="row g-3" >
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0" >
                  {userId ? (
                    <>
                      <Link to="/editprofile" className="hover-link" style={{ textDecoration: "none" }}>
                      ...
                      <p style={{ marginTop: "12px", marginLeft: "5px", color: "white", textShadow: "0.5px 0.5px blue" }}>
                        {user?.displayName}
